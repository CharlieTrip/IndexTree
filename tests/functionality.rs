...
mod functionality {
  ...
  fn incresing_skip() {
    ...
    assert_eq!(it.inc(), Ok((0, false)));
    assert_eq!(*it.get(), [0, 0, 1].to_vec());
    assert_eq!(it.inc_skip(0), Ok((1, true)));
    assert_eq!(*it.get(), [0, 1, 0].to_vec());
    ...
    assert_eq!(it.inc_skip(5), Ok((1, true)));
  ...
  fn incresing_skip_v() {
    ...
    assert_eq!(it.inc(), Ok((0, false)));
    assert_eq!(*it.get(), [0, 0, 1].to_vec());
    assert_eq!(it.inc_skip_v(0), Ok((1, true)));
    assert_eq!(*it.get(), [0, 1, 0].to_vec());
    ...
    assert_eq!(*it.get(), [1, 1, 1].to_vec());
    assert_eq!(it.inc_skip_v(4), Ok((1, true)));
    assert_eq!(*it.get(), [1, 2, 0].to_vec());
